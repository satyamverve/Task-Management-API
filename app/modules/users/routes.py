...
from Final_Demo.app.dto.user_schemas import User, UserSignUp, UserChangePassword, UserOut, UserMe, Token, UserUpdate, UserUpdateMe
...
@router.post("/users",response_model=UserOut, summary="Register a user", tags=["Users"])
...
@router.get("/users",response_model=List[UserOut], summary="Get all users", tags=["Users"])
...
@router.patch("/users",response_model=UserOut,summary="Update a user", tags=["Users"])
...
@router.delete("/users",summary="Delete a user", tags=["Users"])
